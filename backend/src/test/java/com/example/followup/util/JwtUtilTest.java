...
class JwtUtilTest {
 ...
 private JwtUtil jwt(long expiration){JwtUtil jwt=new JwtUtil();ReflectionTestUtils.setField(jwt,"secret","chronic-disease-follow-up-secret-key-2026-challenge-cup");ReflectionTestUtils.setField(jwt,"expiration",expiration);return jwt;}
}
